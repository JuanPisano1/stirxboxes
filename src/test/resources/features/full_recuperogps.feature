...
Feature: Full con Recupero Gps
  ...
  @FullRecuperoGps
  Scenario: Instalacion de solucion Full con Recupero Gps
   Given un turno de Instalacion para la solucion "Full"
    When se filtran tareas por vehiculo
   # When Selecciona un vehiculo con dominio 'ZZ493KM'
   ...
   # When se prueban asserts con Dominio: "ZZ493KM" Solicitud ID: "482561492" DNI: "30061310" GPS: "900100000000299" VLU: ""
    Then se imprimen los datos de la prueba y se espera 50 segundos
