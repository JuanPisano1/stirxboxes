@WholeBoxesFeature
Feature: Recupero con Upgrade a Strix Auto
  Background:
  ...
  Scenario: Instalacion de la solucion Recupero GPS por compania de seguros
    ...
    And Realizar Cierre
    #When se prueban asserts con Dominio: "ZZ330WG" Solicitud ID: "482561325" DNI: "26060925" GPS: "900100000000258" VLU: ""
