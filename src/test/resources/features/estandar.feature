...
#    Then Valida que se ecuentra en correctamente logueado
  ...
  Scenario: Instalacion de la solucion 'Estandar' con servicio adicional Recupero VLU
   ...
   # When Selecciona un vehiculo con dominio 'ZZ438KJ'
#
...
#    And Realizar Cierre
    When se prueban asserts con Dominio: "ZZ438KJ" Solicitud ID: "482561550" DNI: "04071423" GPS: "900100000000095" VLU: "99AA124"
