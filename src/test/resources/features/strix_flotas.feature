@WholeBoxesFeature
Feature: Strix Flotas

  Background:
   Given Genera una solicitud para el servicio "STRIX_FLOTAS" y espera 60 segundos
#    Given un turno de Instalacion para la solucion "STRIX_FLOTAS"
  ...
  @StrixFlotas
  Scenario: Instalacion de la solucion Strix flotas
    Given un turno de Instalacion para la solucion "STRIX_FLOTAS"
    When se filtran tareas por vehiculo
#   When Selecciona un vehiculo con dominio 'SS154SZ'
    And se accede a la tarea de: "Recepción"
    And obtener nro de serie del GPS para "STRIX_FLOTAS"
    ...
    And valida que 'Visualizacion' tenga tilde verde
    ...
    And Realizar Cierre
#    When se prueban asserts con Dominio: "ZZ399TP" Solicitud ID: "482469957" DNI: "35269410" GPS: "900000000000115" VLU: ""
    ...
    And se verifica en Calipso el plan "PL_STRIXFLOTALOG" y el servicio "SE_VISUALIZACION". Company ID "COM_OLEIROS"
