...
Feature: Masivo
  Background:
    Given Genera una solicitud para el servicio "MASIVO" y espera 60 segundos
  ...
  Scenario: Instalacion de la solucion Recupero GPS por compania de seguros
    ...
    #When Selecciona un vehiculo con dominio 'ZZ300VS'
    ...
    And obtener nro de serie del GPS para "Masivo"
    ...
    And Realizar Cierre
   # When se prueban asserts con Dominio: "ZZ802JA" Solicitud ID: "482552553" DNI: "29051355" GPS: "900100000000227" VLU: ""
    Then se imprimen los datos de la prueba y se espera 30 segundos
    And se verifica en Calipso que el equipo "GPS" haya quedado asociado al vehiculo
    And se verifica en Calipso el plan "PL_MASIVO" y el servicio "SE_MONITOREO". Company ID "COM_OLEIROS"
